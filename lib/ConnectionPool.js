...
ConnectionPool.prototype.getDb = function(db_name, cb) {
    var self = this
    db_url = self._getConnectionUrl({ "host": "localhost", "port": "27017", "database_name": db_name});

    if(typeof DATABASE[db_url]!=='undefined') {
